...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    20,   70,   41,   19,   52,    7,   57,    4,   43,   44,
 /*    10 */    45,   46,   47,   48,   51,   18,   41,   19,   24,   11,
 /*    20 */   111,    1,   69,   16,   17,    3,   27,   55,   18,   56,
 /*    30 */    29,    9,   24,   11,   27,   37,   16,   17,    2,    9,
 /*    40 */    62,   24,   61,   58,   18,   60,    5,   28,   62,   24,
 /*    50 */    14,   68,   16,   17,   61,   22,    4,   60,   35,   26,
 /*    60 */    25,   54,   22,   22,   22,   30,   32,   15,   42,   53,
 /*    70 */    63,   38,   39,   40,   21,   23,    6,   49,   50,   10,
 /*    80 */    59,    8,   64,   12,   13,   31,   33,  112,   34,   36,
 /*    90 */   112,   65,   66,  112,   67,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     2,    0,    1,    2,    5,    6,   22,    4,   10,   11,
 /*    10 */    12,   13,   14,   15,   16,   24,    1,    2,   17,   18,
 /*    20 */    29,   30,   31,   32,   33,   21,    2,   22,   24,   22,
 /*    30 */     2,    7,   17,   18,    2,   31,   32,   33,   25,    7,
 /*    40 */    16,   17,   32,   19,   24,   35,   36,   37,   16,   17,
 /*    50 */    23,   31,   32,   33,   32,   28,    4,   35,    2,   37,
 /*    60 */     8,   34,   28,   28,   28,    5,    6,   26,   34,   34,
 /*    70 */    34,    1,    1,    1,    8,    8,    3,    2,    2,    2,
 /*    80 */     1,    3,    1,    9,    4,   20,    2,   38,   20,   20,
 /*    90 */    38,    9,    9,   38,    9,
};
#define YY_SHIFT_USE_DFLT (-3)
#define YY_SHIFT_MAX 36
static const signed char yy_shift_ofst[] = {
 /*     0 */    15,    1,   32,   15,   -2,   24,   -2,   -2,   -2,   52,
 /*    10 */     3,   28,    3,   56,   -1,   60,   70,   71,   72,   73,
 /*    20 */    66,   75,   67,   76,   77,   74,   79,   78,   81,   80,
 /*    30 */    65,   82,   84,   68,   83,   69,   85,
};
#define YY_REDUCE_USE_DFLT (-17)
#define YY_REDUCE_MAX 13
static const signed char yy_reduce_ofst[] = {
 /*     0 */    -9,    4,   10,   20,   27,   22,   34,   35,   36,  -16,
 /*    10 */     5,   13,    7,   41,
};
static const YYACTIONTYPE yy_default[] = {
 /*     0 */   110,  110,  108,  110,   82,  108,  110,  110,  110,   79,
 /*    10 */    79,  110,   79,  101,  110,  110,  110,  110,  110,  110,
 /*    20 */    91,  110,   92,  110,  110,  110,  110,  110,  110,  110,
 /*    30 */   110,  110,  110,  110,  110,  110,  110,   72,   73,   74,
 /*    40 */    75,   76,   77,   85,   86,   87,   88,   89,   90,   95,
 /*    50 */    93,   94,   78,   80,   81,   96,   83,   84,   97,  103,
 /*    60 */   104,  105,  106,  107,  102,   98,  100,   99,  109,   71,
};
...
static const char *const yyTokenName[] = { 
  ...
  "DOT",           "TYPE",          "HEX",           "FLOAT",       
  "INT",           "STR",           "CHR",           "REG",         
  "LABEL",         "PERCENT",       "FUNCTION",      "END",         
  "COLON",         "error",         "parameters",    "args",        
  "function",      "function_decl",  "function_params",  "label",       
  "function_reference",  "module",        "statements",    "statement",   
  "directive",     "constant",      "expr",          "operation",   
  "block",         "element",     
};
...
static const char *const yyRuleName[] = {
 ...
 /*  24 */ "expr ::= LABEL",
 /*  25 */ "function_reference ::= IDENT DOT IDENT",
 /*  26 */ "directive ::= PERCENT IDENT parameters",
 /*  27 */ "function ::= FUNCTION function_decl block END",
 /*  28 */ "function_decl ::= IDENT LPAREN function_params RPAREN COLON TYPE",
 /*  29 */ "function_params ::= IDENT COLON TYPE",
 /*  30 */ "function_params ::= function_params COMMA IDENT COLON TYPE",
 /*  31 */ "function_params ::=",
 /*  32 */ "block ::= element EOL",
 /*  33 */ "block ::= block element EOL",
 /*  34 */ "element ::= operation",
 /*  35 */ "element ::= directive",
 /*  36 */ "element ::= LABEL",
 /*  37 */ "element ::= IDENT EQ expr",
 /*  38 */ "element ::=",
 /*  39 */ "statements ::= statements error statement",
};
